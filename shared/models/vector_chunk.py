...
class VectorChunk(Base):
    ...
    Attributes:
        ...
        vector: 1024-dimensional embedding vector stored as pgvector (mxbai-embed-large).
    ...
    vector: list[float] = Column(Vector(1024), nullable=False)  # mxbai-embed-large: 1024d
    ...
    source_metadata: dict = Column(JSON, nullable=False, default=dict)
